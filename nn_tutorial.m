% Taken from http://www.mathworks.com/matlabcentral/fileexchange/19997-neural-network-for-pattern-recognition-tutorial
...
S1=8;   % number of hidden layers. more hidden layers -> fewer iterations, higher recognition rate
